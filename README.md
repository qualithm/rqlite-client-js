...
[![CI](https://github.com/qualithm/rqlite-client-js/actions/workflows/ci.yaml/badge.svg?branch=main)](https://github.com/qualithm/rqlite-client-js/actions/workflows/ci.yaml)
